 ...
 */
            ...
            /**
            *  ParagraphChoice_type1 bean class
            */
        
        public  class ParagraphChoice_type1
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = paragraphChoice_type1
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ParagraphChoice_type1.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":paragraphChoice_type1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "paragraphChoice_type1",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ParagraphChoice_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ParagraphChoice_type1 object =
                new ParagraphChoice_type1();
