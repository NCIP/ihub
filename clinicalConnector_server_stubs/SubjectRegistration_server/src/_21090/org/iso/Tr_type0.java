 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected _21090.org.iso.TrChoice[] localTrChoice ;
                                

                           /**
                           * Auto generated getter method
                           * @return _21090.org.iso.TrChoice[]
                           */
                           public  _21090.org.iso.TrChoice[] getTrChoice(){
                               return localTrChoice;
                           }
                              ...
                              /**
                               * validate the array for TrChoice
                               */
                              protected void validateTrChoice(_21090.org.iso.TrChoice[] param){
                              ...
                              * @param param TrChoice
                              */
                              public void setTrChoice(_21090.org.iso.TrChoice[] param){
                              
                                   validateTrChoice(param);

                               
                                      this.localTrChoice=param;
                              }
                             ...
                             * @param param _21090.org.iso.TrChoice
                             */
                             public void addTrChoice(_21090.org.iso.TrChoice param){
                                   if (localTrChoice == null){
                                   localTrChoice = new _21090.org.iso.TrChoice[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTrChoice);
                               list.add(param);
                               this.localTrChoice =
                             (_21090.org.iso.TrChoice[])list.toArray(
                            new _21090.org.iso.TrChoice[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Tr_type0.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localValign != null){
                                      ...
                                      if (localTrChoice!=null){
                                            for (int i = 0;i < localTrChoice.length;i++){
                                                if (localTrChoice[i] != null){
                                                 localTrChoice[i].serialize(null,factory,xmlWriter);
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("trChoice cannot be null!!");
                                 ...
                                 for (int i = 0;i < localTrChoice.length;i++){
                                    ...
                                    if (localTrChoice[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("uri:iso.org:21090",
                                                                          "trChoice"));
                                         elementList.add(localTrChoice[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Tr_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Tr_type0 object =
                new Tr_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tr_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Tr_type0)gov.nih.nci.clinicalconnector.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribValign!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(_21090.org.iso.TrChoice.Factory.parse(reader));
                                                        ...
                                                        object.setTrChoice((_21090.org.iso.TrChoice[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                _21090.org.iso.TrChoice.class,
                                                                list1));
