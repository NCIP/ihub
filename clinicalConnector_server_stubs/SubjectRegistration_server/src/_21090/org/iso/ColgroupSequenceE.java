 ...
 */
            ...
            /**
            *  ColgroupSequenceE bean class
            */
        
        public  class ColgroupSequenceE
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = colgroupSequence
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ColgroupSequenceE.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":colgroupSequence",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "colgroupSequence",
                           xmlWriter);
                                           ...
                                           localCol.serialize(new javax.xml.namespace.QName("uri:iso.org:21090","col"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static ColgroupSequenceE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ColgroupSequenceE object =
                new ColgroupSequenceE();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("uri:iso.org:21090","col").equals(reader.getName())){
                                                ...
                                                object.setCol(_21090.org.iso.Col_type0.Factory.parse(reader));
