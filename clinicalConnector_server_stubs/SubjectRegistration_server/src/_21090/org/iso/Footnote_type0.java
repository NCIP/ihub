 ...
 */
            ...
            /**
            *  Footnote_type0 bean class
            */
        
        public  class Footnote_type0
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for FootnoteChoice
                        * This was an Array!
                        */

                        
                                    protected _21090.org.iso.FootnoteChoice[] localFootnoteChoice ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localFootnoteChoiceTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return _21090.org.iso.FootnoteChoice[]
                           */
                           public  _21090.org.iso.FootnoteChoice[] getFootnoteChoice(){
                               return localFootnoteChoice;
                           }
                              ...
                              /**
                               * validate the array for FootnoteChoice
                               */
                              protected void validateFootnoteChoice(_21090.org.iso.FootnoteChoice[] param){
                              ...
                              * @param param FootnoteChoice
                              */
                              public void setFootnoteChoice(_21090.org.iso.FootnoteChoice[] param){
                              
                                   validateFootnoteChoice(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localFootnoteChoiceTracker = true;
                                          } else {
                                             localFootnoteChoiceTracker = false;
                                                 
                                          }
                                      
                                      this.localFootnoteChoice=param;
                              }
                             ...
                             * @param param _21090.org.iso.FootnoteChoice
                             */
                             public void addFootnoteChoice(_21090.org.iso.FootnoteChoice param){
                                   if (localFootnoteChoice == null){
                                   localFootnoteChoice = new _21090.org.iso.FootnoteChoice[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFootnoteChoice);
                               list.add(param);
                               this.localFootnoteChoice =
                             (_21090.org.iso.FootnoteChoice[])list.toArray(
                            new _21090.org.iso.FootnoteChoice[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Footnote_type0.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":footnote_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "footnote_type0",
                           xmlWriter);
                                     ...
                                     if (localFootnoteChoiceTracker){
                                     
                                      if (localFootnoteChoice!=null){
                                            for (int i = 0;i < localFootnoteChoice.length;i++){
                                                if (localFootnoteChoice[i] != null){
                                                 localFootnoteChoice[i].serialize(null,factory,xmlWriter);
                                                } else {
                                        ...
                                        throw new org.apache.axis2.databinding.ADBException("footnoteChoice cannot be null!!");
                                     }
                                 }
                                 ...
                                 for (int i = 0;i < localFootnoteChoice.length;i++){
                                    ...
                                    if (localFootnoteChoice[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("uri:iso.org:21090",
                                                                          "footnoteChoice"));
                                         elementList.add(localFootnoteChoice[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Footnote_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Footnote_type0 object =
                new Footnote_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"footnote_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Footnote_type0)gov.nih.nci.clinicalconnector.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribStyleCode!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(_21090.org.iso.FootnoteChoice.Factory.parse(reader));
                                                        ...
                                                        object.setFootnoteChoice((_21090.org.iso.FootnoteChoice[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                _21090.org.iso.FootnoteChoice.class,
                                                                list1));
