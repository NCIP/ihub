 ...
 * 
 */
public abstract class CaXchangeConsumerServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaXchangeConsumerServiceResourceBase.class);

	private CaXchangeConsumerServiceResourceConfiguration configuration;
    ...
    public CaXchangeConsumerServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaXchangeConsumerServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaXchangeConsumerServiceConstants.SERVICEMETADATA);
	...
	public CaXchangeConsumerServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaXchangeConsumerService";
		...
		try {
			...
			this.configuration = (CaXchangeConsumerServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
