...
public class TestUnknownMessageType extends TestCaXchangeGridService{

	public TestUnknownMessageType(){
		super();
	}
	
	public TestUnknownMessageType(String name){
		super(name);
	}
    ...
    public static Test suite() {
       ...
       suite.addTest(new TestUnknownMessageType("testUnknownMessageType"));
