...
public class GenericInvocationStrategyTest {
	...
	public void testInvokeGridService() {
		...
		try {
			...
			/*
			 * C3DRegistrationInvocationStrategy registrationC3DStrategy = new
			 * C3DRegistrationInvocationStrategy();
			 * registrationC3DStrategy.setServiceType("REGISTER_SUBJECT");
			 * registrationC3DStrategy
			 * .setServiceUrl(TestConstants.REGISTER_SUBJECT_C3D_URL);
			 * registrationC3DStrategy.setGridClientClassName(
			 * "gov.nih.nci.clinicalconnector.client.ClinicalConnectorClient");
			 * registrationC3DStrategy.setRequestPayloadClassName(
			 * "clinicalconnector.nci.nih.gov.RegisterSubjectRequest");
			 * registrationC3DStrategy.setReturnTypeNameSpace(
			 * "http://gov.nci.nih.clinicalconnector/ClinicalConnector");
			 * registrationC3DStrategy
			 * .setReturnTypeElement("RegisterSubjectResponse");
			 * registrationC3DStrategy.setOperationName("registerSubject");
			 * 
			 * Element labBasedAEPayloadDocument = IntegrationHubUtil.
			 * stringToDOMDocument
			 * (TestConstants.REGISTER_SUBJECT_PAYLOAD).getDocumentElement();
			 * 
			 ...
			 * 
			 * GridInvocationResult registerSubjectResponse =
			 * registrationC3DStrategy.invokeGridService(false);
			 * System.out.println
			 * (" C3D Transformed Response: "+IntegrationHubUtil
			 * .xmlToString(registerSubjectResponse.getResult()));
			 * 
			 * GenerateResponseBean generateResponseBean = new
			 * GenerateResponseBean(); Document gridInvocationResultDocument =
			 * generateResponseBean.createOutputDocument("C3D", "",
			 * "gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain",
			 * registerSubjectResponse);
			 * 
			 * String successResponseXML =
			 * IntegrationHubUtil.xmlToString(gridInvocationResultDocument);
			 * System.out.println(" Response: "+successResponseXML);
			 */

			/*
			 * GenericInvocationStrategy ctLabDataStrategy = new
			 * GenericInvocationStrategy();
			 * ctLabDataStrategy.setServiceType("CT_LAB_DATA");
			 * ctLabDataStrategy
			 * .setServiceUrl(TestConstants.CT_LAB_DATA_CTOM_UTL);
			 * ctLabDataStrategy.setGridClientClassName(
			 * "gov.nih.nci.cagrid.labviewer.client.LabLoaderClient");
			 * ctLabDataStrategy.setRequestPayloadClassName("java.lang.String");
			 * ctLabDataStrategy.setReturnTypeNameSpace(
			 * "http://labviewer.cagrid.nci.nih.gov/LabLoader/types");
			 * ctLabDataStrategy.setReturnTypeElement("LoadLabResponse");
			 * ctLabDataStrategy.setOperationName("loadLab");
			 * 
			 * Element labBasedAEPayloadDocument = IntegrationHubUtil.
			 * stringToDOMDocument
			 * (TestConstants.CT_LAB_DATA_PAYLOAD).getDocumentElement();
			 * 
			 ...
			 * ctLabDataStrategy.invokeGridService(false);
			...
			/*
			 * C3DDataCaptureInvocationStrategy loadLabToCDMSStrategy = new
			 * C3DDataCaptureInvocationStrategy();
			 * loadLabToCDMSStrategy.setServiceType("LOAD_LAB_TO_CDMS");
			 * loadLabToCDMSStrategy
			 * .setServiceUrl(TestConstants.LOAD_LAB_TO_CDMS_C3D_UTL);
			 * loadLabToCDMSStrategy.setGridClientClassName(
			 * "gov.nih.nci.clinicalconnector.client.ClinicalConnectorClient");
			 * loadLabToCDMSStrategy.setRequestPayloadClassName(
			 * "clinicalconnector.nci.nih.gov.LoadLabsRequest");
			 * loadLabToCDMSStrategy.setReturnTypeNameSpace(
			 ...
			 * 
			 * // DataCaptureTransformer dataCaptureTransformer = new
			 * DataCaptureTransformer(); // String loadLabConvertedString =
			 * dataCaptureTransformer
			 * .convert2RequestString(TestConstants.LOAD_LAB_TO_CDMS_PAYLOAD);
			 * //System.out.println("LoadLab Converted String: "+
			 * loadLabConvertedString); // String loadLabBusinessString =
			 * IntegrationHubUtil
			 * .convertPayloadIntoBusinessPayload(loadLabConvertedString);
			 * 
			 * Element loadLabToCDMSPayloadDocument = IntegrationHubUtil.
			 * stringToDOMDocument
			 * (TestConstants.LOAD_LAB_TO_CDMS_PAYLOAD).getDocumentElement();
			 * 
			 ...
			 * 
			 * GridInvocationResult studyCreationResponse =
			 * loadLabToCDMSStrategy.invokeGridService(false);
			 * System.out.println
			 * (" Response: "+IntegrationHubUtil.xmlToString(studyCreationResponse
			 * .getResult()));
			 */
			 ...
			 * adverseEventStrategy
			 * .setServiceUrl(TestConstants.SCHEDULE_MODIFICATION_PSC_URL);
			 * adverseEventStrategy.setGridClientClassName(
			 * "gov.nih.nci.cabig.ctms.grid.ae.client.AdverseEventConsumerClient"
			 * );adverseEventStrategy.setRequestPayloadClassName(
			 * "gov.nih.nci.cabig.ccts.ae.domain.AENotificationType");
			 * adverseEventStrategy.setReturnTypeNameSpace(
			 * "gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.ae.domain");
			 ...
			 * stringToDOMDocument
			 * (TestConstants.SCHEDULE_MODIFICATION_PAYLOAD).getDocumentElement
			 * ();
			 * 
			 * adverseEventStrategy.setSubject(subject);
			 * adverseEventStrategy.setServiceProviderName("PSC");
			 * adverseEventStrategy
			 * .setPayload(scheduleModificationPayloadDocument);
			 * 
			 * GridInvocationResult studyCreationResponse =
			 * adverseEventStrategy.invokeGridService(false);
			 * System.out.println(
			 * " Response: "+IntegrationHubUtil.xmlToString(studyCreationResponse
			 * .getResult()));
			 */
			 ...
			 * registrationInvocationStrategy
			 * .setServiceType("REGISTER_SUBJECT");
			 * registrationInvocationStrategy
			 * .setServiceUrl(TestConstants.REGISTER_SUBJECT_CTODS_URL);
			 * registrationInvocationStrategy.setGridClientClassName(
			 * "gov.nih.nci.ccts.grid.client.RegistrationConsumerClient");
			 * registrationInvocationStrategy.setRequestPayloadClassName(
			 * "gov.nih.nci.cabig.ccts.domain.Registration");
			 * registrationInvocationStrategy.setReturnTypeNameSpace(
			 * "gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain");
			 * registrationInvocationStrategy
			 * .setReturnTypeElement("registration");
			 ...
			 * registrationInvocationStrategy
			 * .setPayload(subjectRegistrationPayloadDocument);
			 * 
			 * GridInvocationResult subjectRegistrationResponse =
			 * registrationInvocationStrategy.invokeGridService(false);
			 * 
			 * GenerateResponseBean generateResponseBean = new
			 * GenerateResponseBean();
			 * 
			 * Document gridInvocationResultDocument =
			 * generateResponseBean.createOutputDocument("C3D", "",
			 * "gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain",
			 * subjectRegistrationResponse);
			 * 
			 * System.out.println("Response Document Type: "+
			 * subjectRegistrationResponse.getResult().getNodeType());
			 * System.out
			 * .println("Subject Registration Response: "+IntegrationHubUtil
			 * .xmlToString(subjectRegistrationResponse.getResult()));
			 */
		} catch (Exception e) {
			e.printStackTrace();
			fail(e.getMessage());
