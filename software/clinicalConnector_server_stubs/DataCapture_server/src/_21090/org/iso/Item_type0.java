        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for ItemChoice_type0
                        * This was an Array!
                        */

                        
                                    protected _21090.org.iso.ItemChoice_type0[] localItemChoice_type0 ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localItemChoice_type0Tracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return _21090.org.iso.ItemChoice_type0[]
                           */
                           public  _21090.org.iso.ItemChoice_type0[] getItemChoice_type0(){
                               return localItemChoice_type0;
                           }
                              ...
                              /**
                               * validate the array for ItemChoice_type0
                               */
                              protected void validateItemChoice_type0(_21090.org.iso.ItemChoice_type0[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param ItemChoice_type0
                              */
                              public void setItemChoice_type0(_21090.org.iso.ItemChoice_type0[] param){
                              
                                   validateItemChoice_type0(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localItemChoice_type0Tracker = true;
                                          } else {
                                             localItemChoice_type0Tracker = false;
                                                 
                                          }
                                      
                                      this.localItemChoice_type0=param;
                              }
                             ...
                             * @param param _21090.org.iso.ItemChoice_type0
                             */
                             public void addItemChoice_type0(_21090.org.iso.ItemChoice_type0 param){
                                   if (localItemChoice_type0 == null){
                                   localItemChoice_type0 = new _21090.org.iso.ItemChoice_type0[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localItemChoice_type0);
                               list.add(param);
                               this.localItemChoice_type0 =
                             (_21090.org.iso.ItemChoice_type0[])list.toArray(
                            new _21090.org.iso.ItemChoice_type0[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Item_type0.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                     ...
                                     if (localCaptionTracker){
                                           ...
                                           localCaption.serialize(new javax.xml.namespace.QName("uri:iso.org:21090","caption"),
                                               factory,xmlWriter);
                                        } if (localItemChoice_type0Tracker){
                                     
                                      if (localItemChoice_type0!=null){
                                            for (int i = 0;i < localItemChoice_type0.length;i++){
                                                if (localItemChoice_type0[i] != null){
                                                 localItemChoice_type0[i].serialize(null,factory,xmlWriter);
                                                } else {
                                        ...
                                        throw new org.apache.axis2.databinding.ADBException("itemChoice_type0 cannot be null!!");
                                     }
                                 }
                             ...
                             if (localItemChoice_type0!=null) {
                                 for (int i = 0;i < localItemChoice_type0.length;i++){
                                    ...
                                    if (localItemChoice_type0[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("uri:iso.org:21090",
                                                                          "itemChoice_type0"));
                                         elementList.add(localItemChoice_type0[i]);
                                    } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"item_type0".equals(type)){
                                ...
                                return (Item_type0)gov.nih.nci.clinicalconnector.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribStyleCode!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(_21090.org.iso.ItemChoice_type0.Factory.parse(reader));
                                                        ...
                                                        object.setItemChoice_type0((_21090.org.iso.ItemChoice_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                _21090.org.iso.ItemChoice_type0.class,
                                                                list2));
