 ...
 */
            ...
            /**
            *  Caption_type0 bean class
            */
        
        public  class Caption_type0
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for CaptionChoice
                        * This was an Array!
                        */

                        
                                    protected _21090.org.iso.CaptionChoice[] localCaptionChoice ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCaptionChoiceTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return _21090.org.iso.CaptionChoice[]
                           */
                           public  _21090.org.iso.CaptionChoice[] getCaptionChoice(){
                               return localCaptionChoice;
                           }
                              ...
                              /**
                               * validate the array for CaptionChoice
                               */
                              protected void validateCaptionChoice(_21090.org.iso.CaptionChoice[] param){
                              ...
                              * @param param CaptionChoice
                              */
                              public void setCaptionChoice(_21090.org.iso.CaptionChoice[] param){
                              
                                   validateCaptionChoice(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localCaptionChoiceTracker = true;
                                          } else {
                                             localCaptionChoiceTracker = false;
                                                 
                                          }
                                      
                                      this.localCaptionChoice=param;
                              }
                             ...
                             * @param param _21090.org.iso.CaptionChoice
                             */
                             public void addCaptionChoice(_21090.org.iso.CaptionChoice param){
                                   if (localCaptionChoice == null){
                                   localCaptionChoice = new _21090.org.iso.CaptionChoice[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localCaptionChoice);
                               list.add(param);
                               this.localCaptionChoice =
                             (_21090.org.iso.CaptionChoice[])list.toArray(
                            new _21090.org.iso.CaptionChoice[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Caption_type0.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                     ...
                                     if (localCaptionChoiceTracker){
                                     
                                      if (localCaptionChoice!=null){
                                            for (int i = 0;i < localCaptionChoice.length;i++){
                                                if (localCaptionChoice[i] != null){
                                                 localCaptionChoice[i].serialize(null,factory,xmlWriter);
                                                } else {
                                        ...
                                        throw new org.apache.axis2.databinding.ADBException("captionChoice cannot be null!!");
                                     }
                                 }
                                 ...
                                 for (int i = 0;i < localCaptionChoice.length;i++){
                                    ...
                                    if (localCaptionChoice[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("uri:iso.org:21090",
                                                                          "captionChoice"));
                                         elementList.add(localCaptionChoice[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static Caption_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Caption_type0 object =
                new Caption_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"caption_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Caption_type0)gov.nih.nci.clinicalconnector.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribStyleCode!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(_21090.org.iso.CaptionChoice.Factory.parse(reader));
                                                        ...
                                                        object.setCaptionChoice((_21090.org.iso.CaptionChoice[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                _21090.org.iso.CaptionChoice.class,
                                                                list1));
