...
public class TranscendSemanticAdapterService extends Service {
    ...
    private final static QName SERVICE = new QName("http://cacis.nci.nih.gov", "TranscendSemanticAdapter");
    private final static QName AcceptSourcePortSoap11 = new QName(// NOPMD
