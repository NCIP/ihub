...
/**
 * This class was generated by Apache CXF 2.4.1 2012-04-17T17:24:21.899-04:00 Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "SemanticAdapter", 
wsdlLocation = "file:/C:/iHub/projects/transcend-sa/src/main/resources/wsdl/SemanticAdapter.wsdl", 
...
public class TranscendSemanticAdapterService extends Service {
    ...
    private static final  QName SERVICE = new QName("http://cacis.nci.nih.gov", "TranscendSemanticAdapter");
    private static final  QName ACCEPTSOURCEPPORTSOAP11 = new QName("http://cacis.nci.nih.gov", "AcceptSource_Port_Soap11");

    static {
        URL url = null;
        try {
            url = new URL(
                    "file:/C:/iHub/projects/transcend-sa/src/main/resources/wsdl/TranscendSemanticAdapter.wsdl");
    ...
    public AcceptSourcePortType getAcceptSourcePortSoap11() {
        return super.getPort(ACCEPTSOURCEPPORTSOAP11, AcceptSourcePortType.class);
    }
    ...
    public AcceptSourcePortType getAcceptSourcePortSoap11(WebServiceFeature... features) {
        return super.getPort(ACCEPTSOURCEPPORTSOAP11, AcceptSourcePortType.class, features);
    }
