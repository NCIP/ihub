...
public class CustomUrlClassLoader extends URLClassLoader {
     ...
     */
    public CustomUrlClassLoader(String... customLocations) throws MalformedURLException {
        super(getCustomUrls(customLocations), CustomUrlClassLoader.class.getClassLoader());
    }
     ...
     * @throws MalformedURLException - exception thrown, if any
     */
    public CustomUrlClassLoader(ClassLoader parent, String... customLocations) throws MalformedURLException {
        super(getCustomUrls(customLocations), parent);
    }

    private static URL[] getCustomUrls(String... customLocations) throws MalformedURLException {
    ...
    private static void addFilesToList(String customLocation, List urlsList) throws MalformedURLException {
        ...
        if (jarFiles == null || jarFiles.length == 0) {
            throw new IllegalArgumentException("The specified custom location does not contain any files, "
                    + customLocation);
        }
