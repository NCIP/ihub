 ...
 * ${user.home}/.integration/${project.name}/${propertyFile.name} project will simply ignore that property from other
 * property files.
 * 
...
public final class CommonsPropertyLoaderUtil {
    ...
    public static Properties loadProperties(final String projectName, final String propertyFileName) {
        ...
        final String appHomePathToScan = String.format("app.home/.integration/%s/%s", projectName, propertyFileName);
