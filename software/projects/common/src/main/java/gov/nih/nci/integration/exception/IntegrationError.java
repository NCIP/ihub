...
public enum IntegrationError {
	...
	_1018(1018, ErrorType.TRANSFORMATION, "Registration transformation failed.${0}"),
	...
	_1024(1018, ErrorType.TRANSFORMATION, "Adverse Event transformation failed.${0}"),
	...
	_1041(1041, ErrorType.TRANSFORMATION, "Transformation to CaCISRequest failed.${0}"),
	_1042(1042, ErrorType.TRANSMISSION, "Could not persist source message."),
	_1043(1042, ErrorType.TRANSMISSION, "Error from CaCISChannel: ${0}"),
	_1050(1050, ErrorType.VALIDATION, "Unknown message type."),
	
	_1051(1051, ErrorType.TRANSMISSION, "Error while invoking CaTissueClient: ${0}"),
	_1052(1052, ErrorType.TRANSMISSION, "Error initializing CaTissueClient: ${0}"),
	_1053(1053, ErrorType.TRANSMISSION, "Error while invoking CaAERSClient: ${0}"),
	_1054(1054, ErrorType.TRANSMISSION, "Error initializing CaAERSClient: ${0}"),
