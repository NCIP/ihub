...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Schema for iHub manage adverse events CDA request"
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Schema for iHub manage adverse events CDA request</svrl:text>
   ...
   <!--PATTERN Guidance For BreastCoreBiopsy Type-->
	...
	<xsl:template match="//cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.22.4.8'][cda:code/cda:originalText='Grade']/cda:value/cda:originalText" priority="1000"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		...
		<xsl:choose>
	         <xsl:when test="text()='CTCAE Grade 1' or text()='CTCAE Grade 2' or text()='CTCAE Grade 3' or text()='CTCAE Grade 4' or text()='CTCAE Grade 5'"/>
	         <xsl:otherwise>
	            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	                                test="text()='CTCAE Grade 1' or text()='CTCAE Grade 2' or text()='CTCAE Grade 3' or text()='CTCAE Grade 4' or text()='CTCAE Grade 5'">
	               <xsl:attribute name="flag">error</xsl:attribute>
	               <xsl:attribute name="location">
	                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
	               </xsl:attribute>
	               <svrl:text>
					The Adverse Event Grade has to be of the format 'CTCAE Grade [1-5]'
				</svrl:text>
	            </svrl:failed-assert>
	         </xsl:otherwise>
	      </xsl:choose>
