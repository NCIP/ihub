...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">CDA body (biospecimen): Available Quantity, Initial Quantity, Barcode, Collection Protocol Short Title, Collection Protocol Title, Specimen Characteristics Side, Specimen Class, Specimen Type, Guidance for Breast Core Biopsy</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA body (biospecimen id/timepoint): CDMS Specimen ID, Study Calendar Event Time Point</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="/hl7:ClinicalDocument" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/hl7:ClinicalDocument"/>
...
<xsl:choose>
   ...
   <!--PATTERN biospecimenCDA body (biospecimen): Available Quantity, Initial Quantity, Barcode, Collection Protocol Short Title, Collection Protocol Title, Specimen Characteristics Side, Specimen Class, Specimen Type, Guidance for Breast Core Biopsy-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA body (biospecimen): Available Quantity, Initial Quantity, Barcode, Collection Protocol Short Title, Collection Protocol Title, Specimen Characteristics Side, Specimen Class, Specimen Type, Guidance for Breast Core Biopsy</svrl:text>

	  <!--RULE -->
<xsl:template match="/hl7:ClinicalDocument" priority="1002" mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/hl7:ClinicalDocument"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.10.20.22.2.31'][@assigningAuthorityName='HL7 CCDA']][hl7:code[@code='59773-2'][@codeSystem='2.16.840.1.113883.6.1']]/hl7:entry[@typeCode='DRIV']/hl7:procedure[@classCode='PROC'][@moodCode='EVN'][hl7:templateId[@root='2.16.840.1.113883.10.20.22.4.14'][@assigningAuthorityName='HL7 CCDA']])!=0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
