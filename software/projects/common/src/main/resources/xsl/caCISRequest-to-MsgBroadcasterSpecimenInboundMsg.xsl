	...
	<xsl:template
		...
		<specimenDetail>
			...
			<specimen>
				...
				<specimenType>
					<xsl:value-of
						select="$observation/ns1:entryRelationship/ns1:observation[ns1:templateId/@root='2.16.840.1.113883.10.20.22.4.2'][ns1:code[@code='371439000'][@codeSystem='2.16.840.1.113883.6.96']]/ns1:value/ns1:originalText"></xsl:value-of>
				</specimenType>
				<initialQuantity>
					<xsl:value-of
				...
				<specimenCharacteristics>
					<tissueSite>Not Specified</tissueSite>
					<tissueSide>
						<xsl:value-of
