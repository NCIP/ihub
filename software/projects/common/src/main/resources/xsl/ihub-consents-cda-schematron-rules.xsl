...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			title="iHUB_Data_Exchange_CDA_Mapping Consent Data" schemaVersion="1.0">
			<xsl:comment>
	...
	<!--SCHEMATRON PATTERNS -->
	<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">iHUB_Data_Exchange_CDA_Mapping Consent
		Data
	</svrl:text>
	...
	<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA header: birthdate, ethnicity,
		gender, race and identifiers (MRN, subject, site, study)
	</svrl:text>
	...
	<!--PATTERN biospecimen_id_timepointCDA body (biospecimen id/timepoint): 
		CDMS Specimen ID, Study Calendar Event Time Point -->
	<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA body (biospecimen id/timepoint):
		CDMS Specimen ID, Study Calendar Event Time Point
	</svrl:text>

	<!--RULE -->
	<xsl:template match="/hl7:ClinicalDocument" priority="1000"
		mode="M7">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			context="/hl7:ClinicalDocument" />
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                  ...
                  <xsl:apply-templates select="."
					...
					<svrl:text>Unavailable biospecimen Study Calendar Event Time Point
					</svrl:text>
				</svrl:failed-assert>
			</xsl:otherwise>
		</xsl:choose>
	...
	<!--PATTERN consentCDA body (consent): date/time, Tier 1 response, Tier2 
		response -->
	<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA body (consent): date/time, Tier 1
		response, Tier2 response
	</svrl:text>

	<!--RULE -->
	<xsl:template match="/hl7:ClinicalDocument" priority="1001"
		mode="M8">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			context="/hl7:ClinicalDocument" />
	...
	<!--RULE -->
	<xsl:template
		match="/hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section/hl7:entry[@typeCode='DRIV']/hl7:observation[@classCode='OBS'][@moodCode='EVN'][hl7:templateId[@root='2.16.840.1.113883.10.20.22.4.2']][hl7:code[@code='309370004'][@codeSystem='2.16.840.1.113883.6.96'][hl7:originalText]]"
		priority="1000" mode="M8">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
