...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">additional_race</xsl:attribute>
            <xsl:attribute name="name">CDA body: additional race(s)</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
   ...
   <!--PATTERN additional_raceCDA body: additional race(s)-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CDA body: additional race(s)</svrl:text>
