...
public class CqlUtility {
    ...
    public static CQLQuery getParticipantsForCP(String shortTitle) {
        ...
        CQLAssociation association1 = createAssociation(CollectionProtocolRegistration.class,
    ...
    public static CQLQuery getSpecimenMalePPI(String ppi) {
        ...
        CQLAttribute attribute2Association2 = createAttribute("protocolParticipantIdentifier", ppi,
                CQLPredicate.EQUAL_TO);
        CQLGroup group3 = createGroup(CQLLogicalOperator.AND, attribute1Association2, attribute2Association2,
                association3);

        CQLAssociation association2 = createAssociation(CollectionProtocolRegistration.class,
    ...
    private static CQLAssociation createAssociationWithIDNotNullandOtherAttribute(Class<?> klass, String roleName,
            String name, String value, CQLPredicate predicate, CQLLogicalOperator operator) {
    ...
    private static CQLAssociation createCPAssociationWithIDandTitle(String shortTitle) {
        return createAssociationWithIDNotNullandOtherAttribute(CollectionProtocol.class, "collectionProtocol",
                "shortTitle", shortTitle, CQLPredicate.EQUAL_TO, CQLLogicalOperator.AND);
    }
    ...
    public static CQLQuery getSpecimenCollectionGroupListQuery(String shortTitle, String label) {
        ...
        CQLGroup group1 = createGroup(CQLLogicalOperator.AND, association11Attribute, association12Attribute,
                association2);
