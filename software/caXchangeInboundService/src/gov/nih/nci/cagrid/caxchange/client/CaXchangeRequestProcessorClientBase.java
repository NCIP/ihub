 ...
 */
public abstract class CaXchangeRequestProcessorClientBase extends ServiceSecurityClient {	
	...
	public CaXchangeRequestProcessorClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CaXchangeRequestProcessorClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected CaXchangeRequestProcessorPortType createPortType() throws RemoteException {
