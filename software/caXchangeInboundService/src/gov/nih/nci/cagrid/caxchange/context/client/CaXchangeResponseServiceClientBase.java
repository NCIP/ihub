 ...
 */
public abstract class CaXchangeResponseServiceClientBase extends ServiceSecurityClient {	
	...
	public CaXchangeResponseServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CaXchangeResponseServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected CaXchangeResponseServicePortType createPortType() throws RemoteException {
