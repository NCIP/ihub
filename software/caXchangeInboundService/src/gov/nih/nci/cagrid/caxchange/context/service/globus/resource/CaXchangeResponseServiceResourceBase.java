 ...
 * 
 */
public abstract class CaXchangeResponseServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CaXchangeResponseServiceResourceBase.class);

	private CaXchangeResponseServiceResourceConfiguration configuration;
    ...
    public CaXchangeResponseServiceResourceBase() {
    }
	...
	public gov.nih.nci.caxchange.ResponseMessage getCaXchangeResponseMessage(){
		return ((CaXchangeResponseServiceResourceProperties) getResourceBean()).getCaXchangeResponseMessage();
	}
	
	public void setCaXchangeResponseMessage(gov.nih.nci.caxchange.ResponseMessage caXchangeResponseMessage ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaXchangeResponseServiceConstants.CAXCHANGERESPONSEMESSAGE);
		prop.set(0, caXchangeResponseMessage);
	}
	...
	public CaXchangeResponseServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CaXchangeResponseServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
