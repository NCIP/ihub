...
public class CaXchangeRequestProcessorAuthorization implements PDP {
	...
	public static final String SERVICE_NAMESPACE = "http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CaXchangeRequestProcessorAuthorization() {
	}
	...
	public void authorizeProcessRequestAsynchronously(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeProcessRequestSynchronously(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeProcessRequestAsynchronously(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("processRequestSynchronously")){
			authorizeProcessRequestSynchronously(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
