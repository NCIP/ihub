 ...
 * 
 */
public abstract class CaXchangeRequestProcessorResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(CaXchangeRequestProcessorResourceBase.class);

	private CaXchangeRequestProcessorResourceConfiguration configuration;
    ...
    public CaXchangeRequestProcessorResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaXchangeRequestProcessorResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaXchangeRequestProcessorConstants.SERVICEMETADATA);
	...
	public CaXchangeRequestProcessorResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaXchangeRequestProcessor";
		...
		try {
			...
			this.configuration = (CaXchangeRequestProcessorResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
