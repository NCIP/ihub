/**
 * CaXchangeRequestProcessorReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.cagrid.caxchange.stubs.types;

public class CaXchangeRequestProcessorReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public CaXchangeRequestProcessorReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this CaXchangeRequestProcessorReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this CaXchangeRequestProcessorReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaXchangeRequestProcessorReference)) return false;
        CaXchangeRequestProcessorReference other = (CaXchangeRequestProcessorReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaXchangeRequestProcessorReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/types", ">CaXchangeRequestProcessorReference"));
