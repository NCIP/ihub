/**
 * CaXchangeResponseServiceReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.cagrid.caxchange.context.stubs.types;

public class CaXchangeResponseServiceReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public CaXchangeResponseServiceReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this CaXchangeResponseServiceReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this CaXchangeResponseServiceReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaXchangeResponseServiceReference)) return false;
        CaXchangeResponseServiceReference other = (CaXchangeResponseServiceReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaXchangeResponseServiceReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/Context/types", ">CaXchangeResponseServiceReference"));
