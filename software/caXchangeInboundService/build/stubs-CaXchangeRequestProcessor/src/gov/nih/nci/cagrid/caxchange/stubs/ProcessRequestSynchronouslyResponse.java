/**
 * ProcessRequestSynchronouslyResponse.java
 *
...
public class ProcessRequestSynchronouslyResponse  implements java.io.Serializable {
    private gov.nih.nci.caxchange.ResponseMessage caXchangeResponseMessage;

    public ProcessRequestSynchronouslyResponse() {
    }
    ...
    /**
     * Gets the caXchangeResponseMessage value for this ProcessRequestSynchronouslyResponse.
     * 
    ...
    /**
     * Sets the caXchangeResponseMessage value for this ProcessRequestSynchronouslyResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProcessRequestSynchronouslyResponse)) return false;
        ProcessRequestSynchronouslyResponse other = (ProcessRequestSynchronouslyResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessRequestSynchronouslyResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">ProcessRequestSynchronouslyResponse"));
