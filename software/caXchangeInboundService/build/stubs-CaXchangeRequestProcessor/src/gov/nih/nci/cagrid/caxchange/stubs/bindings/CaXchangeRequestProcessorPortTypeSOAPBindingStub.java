...
public class CaXchangeRequestProcessorPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements gov.nih.nci.cagrid.caxchange.stubs.CaXchangeRequestProcessorPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/types", "CaXchangeFault"),
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("processRequestSynchronously");
        oper.addParameter(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", "ProcessRequestSynchronouslyRequest"), new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">ProcessRequestSynchronouslyRequest"), gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">ProcessRequestSynchronouslyResponse"));
        oper.setReturnClass(gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", "ProcessRequestSynchronouslyResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/types", "CaXchangeFault"),
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/Context/types", "CaXchangeFault");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.context.stubs.types.CaXchangeFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">ProcessRequestSynchronouslyResponse");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">ProcessRequestSynchronouslyRequest");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/types", "CaXchangeFault");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.stubs.types.CaXchangeFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/types", "CaXchangeResponseNotReadyFault");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.stubs.types.CaXchangeResponseNotReadyFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/Context/types", "CaXchangeResponseNotReadyFault");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.context.stubs.types.CaXchangeResponseNotReadyFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor", ">>ProcessRequestSynchronouslyRequest>caXchangeRequestMessage");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyRequestCaXchangeRequestMessage.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse processRequestSynchronously(gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyRequest parameters) throws java.rmi.RemoteException, gov.nih.nci.cagrid.caxchange.stubs.types.CaXchangeFault {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://caxchange.cagrid.nci.nih.gov/CaXchangeRequestProcessor/ProcessRequestSynchronouslyRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "processRequestSynchronously"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse) org.apache.axis.utils.JavaUtils.convert(_resp, gov.nih.nci.cagrid.caxchange.stubs.ProcessRequestSynchronouslyResponse.class);
            }
        }
    }
