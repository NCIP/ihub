/**
 * RollbackRequestCaXchangeRequestMessage.java
 *
...
public class RollbackRequestCaXchangeRequestMessage  implements java.io.Serializable {
    private gov.nih.nci.caxchange.Message caXchangeRequestMessage;

    public RollbackRequestCaXchangeRequestMessage() {
    }
    ...
    /**
     * Gets the caXchangeRequestMessage value for this RollbackRequestCaXchangeRequestMessage.
     * 
    ...
    /**
     * Sets the caXchangeRequestMessage value for this RollbackRequestCaXchangeRequestMessage.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RollbackRequestCaXchangeRequestMessage)) return false;
        RollbackRequestCaXchangeRequestMessage other = (RollbackRequestCaXchangeRequestMessage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RollbackRequestCaXchangeRequestMessage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.nci.nih.gov/CaXchangeConsumerService", ">>RollbackRequest>caXchangeRequestMessage"));
