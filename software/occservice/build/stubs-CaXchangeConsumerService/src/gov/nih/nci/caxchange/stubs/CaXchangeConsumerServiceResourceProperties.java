/**
 * CaXchangeConsumerServiceResourceProperties.java
 *
...
public class CaXchangeConsumerServiceResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public CaXchangeConsumerServiceResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this CaXchangeConsumerServiceResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this CaXchangeConsumerServiceResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaXchangeConsumerServiceResourceProperties)) return false;
        CaXchangeConsumerServiceResourceProperties other = (CaXchangeConsumerServiceResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaXchangeConsumerServiceResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.nci.nih.gov/CaXchangeConsumerService", ">CaXchangeConsumerServiceResourceProperties"));
