/**
 * ProcessRequestCaXchangeRequestMessage.java
 *
...
public class ProcessRequestCaXchangeRequestMessage  implements java.io.Serializable {
    private gov.nih.nci.caxchange.Message caXchangeRequestMessage;

    public ProcessRequestCaXchangeRequestMessage() {
    }
    ...
    /**
     * Gets the caXchangeRequestMessage value for this ProcessRequestCaXchangeRequestMessage.
     * 
    ...
    /**
     * Sets the caXchangeRequestMessage value for this ProcessRequestCaXchangeRequestMessage.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProcessRequestCaXchangeRequestMessage)) return false;
        ProcessRequestCaXchangeRequestMessage other = (ProcessRequestCaXchangeRequestMessage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessRequestCaXchangeRequestMessage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.nci.nih.gov/CaXchangeConsumerService", ">>ProcessRequest>caXchangeRequestMessage"));
