...
public class CaXchangeResponseServiceAuthorization implements PDP {
	...
	public void authorizeGetResponse(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getResponse")){
			authorizeGetResponse(peerSubject, context, operation);
			return true;
