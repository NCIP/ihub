/**
 * ServicePointOfContactCollection.java
 *
...
public class ServicePointOfContactCollection  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.common.PointOfContact[] pointOfContact;

    public ServicePointOfContactCollection() {
    }
    ...
    /**
     * Gets the pointOfContact value for this ServicePointOfContactCollection.
     * 
    ...
    /**
     * Sets the pointOfContact value for this ServicePointOfContactCollection.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ServicePointOfContactCollection)) return false;
        ServicePointOfContactCollection other = (ServicePointOfContactCollection) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServicePointOfContactCollection.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caGrid.caBIG/1.0/gov.nih.nci.cagrid.metadata.service", ">Service>pointOfContactCollection"));
