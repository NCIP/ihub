/**
 * CommitRequestCaXchangeRequestMessage.java
 *
...
public class CommitRequestCaXchangeRequestMessage  implements java.io.Serializable {
    private gov.nih.nci.caxchange.Message caXchangeRequestMessage;

    public CommitRequestCaXchangeRequestMessage() {
    }
    ...
    /**
     * Gets the caXchangeRequestMessage value for this CommitRequestCaXchangeRequestMessage.
     * 
    ...
    /**
     * Sets the caXchangeRequestMessage value for this CommitRequestCaXchangeRequestMessage.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommitRequestCaXchangeRequestMessage)) return false;
        CommitRequestCaXchangeRequestMessage other = (CommitRequestCaXchangeRequestMessage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CommitRequestCaXchangeRequestMessage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caxchange.nci.nih.gov/CaXchangeConsumerService", ">>CommitRequest>caXchangeRequestMessage"));
