 ...
 * 
 */
public class CaXchangeConsumerServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caxchange.nci.nih.gov/CaXchangeConsumerService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CaXchangeConsumerServiceAuthorization() {
	}
	...
	public void authorizeProcess(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeCommit(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeRollback(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("process")){
			authorizeProcess(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("commit")){
			authorizeCommit(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("rollback")){
			authorizeRollback(peerSubject, context, operation);
			return true;
