 ...
 * 
 */
public class CustomClasspathXmlApplicationContext extends
	 ...
	 *            Array of spring xml file locations
	 ...
	 *             - Exception thrown, if any
	 */
	public CustomClasspathXmlApplicationContext(String customLocation,
	 ...
	 *             - Exception thrown, if any
	 */
	public CustomClasspathXmlApplicationContext(String[] customLocations,
			String... configLocations) throws BeansException,
			MalformedURLException {
		super();
	...
	private void init(String[] customLocation) throws MalformedURLException {
		final CustomUrlClassLoader jcl = new CustomUrlClassLoader(
				customLocation);
		setClassLoader(jcl);
