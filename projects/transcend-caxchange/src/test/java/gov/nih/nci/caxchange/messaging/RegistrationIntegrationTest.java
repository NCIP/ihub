...
public class RegistrationIntegrationTest {
	...
	private final static SimpleDateFormat ssnsdf = new SimpleDateFormat(
			"MM-ddmm");

	private static String TRANSCEND_CAXCHANGE_URL = "https://sb-admin-cp-pc:7443/transcend-caxchange/services/CaXchangeRequestService";
	// private static String TRANSCEND_CAXCHANGE_URL =
	// "http://localhost:12090/services/CaXchangeRequestService";
	...
	public void sendInvalidIHubCredentialsMessage() {
		try {
			HttpPost httppost = new HttpPost(TRANSCEND_CAXCHANGE_URL);
			...
			if (entity != null) {
				...
				Assert.assertEquals(getInvalidCredentialsCreateMsg(), output);
			}
	...
	public void sendRegistrationMessage() {
		try {
			...
			if (entity != null) {
				...
				System.out.println(output);
				Assert.assertNotNull(output);
				Assert.assertEquals(getSuccessCreateMsg(), output);
			}
		} catch (ClientProtocolException e) {
			Assert.fail(e.getMessage());
		} catch (IllegalStateException e) {
	...
	public void sendUpdateRegistrationMessage() {
		try {
			...
			if (entity != null) {
				...
				System.out.println(output);
				Assert.assertNotNull(output);
				Assert.assertEquals(getSuccessUpdateMsg(), output);
			}
		} catch (ClientProtocolException e) {
			Assert.fail(e.getMessage());
		} catch (IllegalStateException e) {
		...
		try {
			...
			if (entity != null) {
				...
				Assert.assertEquals(true, output
						.contains("<errorCode>1014</errorCode>"));
			}
		} catch (ClientProtocolException e) {
			Assert.fail(e.getMessage());
		} catch (IllegalStateException e) {
	...
	public void sendInvalidStudyRegistrationMessage() {
		try {
			...
			if (entity != null) {
				...
				Assert.assertNotNull(output);
				Assert.assertEquals(true, output
						.contains("<errorCode>1009</errorCode>"));
			}
		} catch (ClientProtocolException e) {
			Assert.fail(e.getMessage());
		} catch (IllegalStateException e) {
	...
	public void sendInvalidInstitutionRegistrationMessage() {
		try {
			...
			if (entity != null) {
				...
				Assert.assertNotNull(output);
				Assert.assertEquals(true, output
						.contains("<errorCode>1012</errorCode>"));
			}
		} catch (ClientProtocolException e) {
			Assert.fail(e.getMessage());
		} catch (IllegalStateException e) {
