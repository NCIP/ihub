...
/**
 * This class was generated by Apache CXF 2.4.1 2012-04-11T16:58:55.116-04:00
...
public class TranscendSemanticAdapter extends AcceptMessage {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(TranscendSemanticAdapter.class.getName());

	private String customLibDir = "custom-lib/";

	private JAXBContext jc = null;

	public TranscendSemanticAdapter(
			WebServiceMessageReceiver webServiceMessageReceiver) {
		super(webServiceMessageReceiver);
	}

	/**
	 * AcceptSource operation accepts data from Clinical Source system and sends
	 * it to Mirth Connect for processing
	 * 
	 * @param parameter
	 *            caCISRequest
	...
	public CaCISResponse acceptSource(
		...
		try {
			...
			if (mcResponse != null
				...
				AcceptSourceFault fault = new AcceptSourceFault(
						"Error processing Data from Source System",
			...
			AcceptSourceFault fault = new AcceptSourceFault(
					"Error accepting Data from Source System!"
							+ ex.getMessage(), cf);
			throw fault;
		}
	}
	...
	private String stackTraceAsString(Exception e) {
		try {
			return URLEncoder.encode(ExceptionUtils.getFullStackTrace(e),
					"UTF-8");
