...
public class AcceptSourceFaultTest {
	...
	private final static QName _CaCISFault_QNAME = new QName("http://cacis.nci.nih.gov", "caCISFault");
	...
	private String getCaCISFaultxml(final CaCISFault parameter) {
        try {           
        	...
        	JAXBElement<CaCISFault> cfj = 
        		new JAXBElement<CaCISFault>(_CaCISFault_QNAME, CaCISFault.class, parameter);
