...
public class CaAERSRegistrationServiceInvocationStrategyIntegrationTest {
    ...
    public void createParticipant() {
        ...
        ServiceBroadcaster sb = new DefaultServiceBroadcaster(serviceInvocationMessageDao);
        ...
        ServiceInvocationMessage resultMsg = msgsMap.get(caAersRegistrationServiceInvocationStrategy
                .getStrategyIdentifier());
        Assert.assertNotNull(resultMsg);
        Assert.assertNotNull(resultMsg.getInvocationException());

        ServiceInvocationResult result = caAersRegistrationServiceInvocationStrategy.rollback(resultMsg);
    ...
    public void updateParticipant() {
        ...
        ServiceInvocationMessage resultMsg = msgsMap.get(caAersUpdateRegistrationServiceInvocationStrategy
                .getStrategyIdentifier());
        Assert.assertNotNull(resultMsg);
        Assert.assertNotNull(resultMsg.getInvocationException());
        ...
        ServiceInvocationResult result = caAersUpdateRegistrationServiceInvocationStrategy.rollback(resultMsg);
        Assert.assertNotNull(result);
        Assert.assertTrue(result.isFault());
    }
