...
public final class CqlUtility {
    ...
    /**
     * Get the CQLQuery for the getting ALL specimens for One SpecimenCollectionGroup Id
     * @param scgId - SCG Id
     * @return - query
     */
    public static CQLQuery getSpecimenCollectionFromSCG(Long scgId) {
        final CQLAttribute association2Attribute = createAttribute("id", scgId + "", CQLPredicate.EQUAL_TO); // NOPMD
        final CQLAssociation association2 = createAssociation(SpecimenCollectionGroup.class, "specimenCollectionGroup");
        association2.setAttribute(association2Attribute);

        final CQLAttribute targetAttribute = createAttribute("id", null, CQLPredicate.IS_NOT_NULL);
        final CQLGroup group0 = createGroup(CQLLogicalOperator.AND, targetAttribute, association2);

        return createTargetQuery(Specimen.class, group0);
    }
     ...
     */
    /*
     * public static CQLQuery getSpecimenCollectionForAPatientAndSCG(String shortTitle, String cpLabel, String
     * patientId) { final CQLAttribute association2Attribute = createAttribute(SHORT_TITLE, shortTitle,
     * CQLPredicate.EQUAL_TO); final CQLAssociation association2 = createAssociation(CollectionProtocol.class,
     * COLLECTION_PROTOCOL); association2.setAttribute(association2Attribute);
     * 
     * final CQLAttribute association11Attribute = createAttribute("id", null, CQLPredicate.IS_NOT_NULL); final
     * CQLAttribute association12Attribute = createAttribute("collectionPointLabel", cpLabel, CQLPredicate.EQUAL_TO);
     * final CQLGroup group1 = createGroup(CQLLogicalOperator.AND, association11Attribute, association12Attribute,
     * association2); final CQLAssociation association1 = createAssociation(CollectionProtocolEvent.class,
     * "collectionProtocolEvent"); association1.setGroup(group1);
     * 
     * final CQLAttribute association32Attribute = createAttribute("lastName", patientId, CQLPredicate.EQUAL_TO); final
     * CQLAssociation association32 = createAssociation(Participant.class, "participant");
     * association32.setAttribute(association32Attribute);
     * 
     * final CQLAttribute association31Attribute = createAttribute("id", null, CQLPredicate.IS_NOT_NULL); final CQLGroup
     * group31 = createGroup(CQLLogicalOperator.AND, association31Attribute, association2, association32);
     * 
     * final CQLAssociation association31 = createAssociation(CollectionProtocolRegistration.class,
     * "collectionProtocolRegistration"); association1.setGroup(group31);
     * 
     * final CQLAttribute association3Attribute = createAttribute("id", null, CQLPredicate.IS_NOT_NULL); final CQLGroup
     * group3 = createGroup(CQLLogicalOperator.AND, association3Attribute, association1, association31);
     * 
     ...
     * 
     * final CQLAttribute association4Attribute = createAttribute("id", null, CQLPredicate.IS_NOT_NULL); final CQLGroup
     * group4 = createGroup(CQLLogicalOperator.AND, association4Attribute, association3);
     * 
     * final CQLQuery query = createTargetQuery(Specimen.class, group4); return query; //NOPMD }
     */
}
